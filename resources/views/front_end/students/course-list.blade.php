    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-xl-12 col-lg-12 col-md-12 col-12">
          <div>
            <h1 class="mb-0 text-white display-4">All Courses</h1>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="card">
            ...
            <div class="card-body border-top">
              ...
              <div class="custom-control custom-radio mb-1">
                ...
                <label class="custom-control-label" for="starRadio2"> <i class="mdi mdi-star mr-n1 text-warning"></i>
                  <i class="mdi mdi-star mr-n1 text-warning"></i>
                  <i class="mdi mdi-star mr-n1 text-warning"></i>
                  <i class="mdi mdi-star mr-n1 text-warning"></i>
                  <i class="mdi mdi-star text-warning "></i>
              ...
              <div class="custom-control custom-radio mb-1">
                ...
                <label class="custom-control-label" for="starRadio3"> <i class="mdi mdi-star mr-n1 text-warning"></i>
                  <i class="mdi mdi-star mr-n1 text-warning"></i>
                  <i class="mdi mdi-star mr-n1 text-warning"></i>
                  <i class="mdi mdi-star mr-n1 text-warning"></i>
                  <i class="mdi mdi-star text-warning "></i>
              ...
              <div class="custom-control custom-radio mb-1">
                ...
                <label class="custom-control-label" for="starRadio4"> <i class="mdi mdi-star mr-n1 text-warning"></i>
                  <i class="mdi mdi-star mr-n1 text-warning"></i>
                  <i class="mdi mdi-star mr-n1 text-warning"></i>
                  <i class="mdi mdi-star mr-n1 text-warning"></i>
                  <i class="mdi mdi-star text-warning "></i>
          ...
          <div class="tab-content">
              ...
              <div class="row">
                <div class="col-lg-4 col-md-6 col-12">
                  ...
                  <div class="card  mb-4 card-hover">
                    <a href="course-single.html" class="card-img-top"><img src="../assets/images/course-react.jpg" alt=""
                ...
                <div class="col-lg-4 col-md-6 col-12">
                  <!-- Card -->
                  <div class="card mb-4 card-hover">
                    <a href="course-single.html" class="card-img-top"><img src="../assets/images/course-graphql.jpg" alt=""
                        class="card-img-top rounded-top"></a>
                    <!-- Card body -->
                    <div class="card-body">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                  <!-- Card -->
                  <div class="card mb-4 card-hover">
                    <a href="course-single.html" class="card-img-top"><img src="../assets/images/course-angular.jpg" alt=""
                        class="card-img-top rounded-top"></a>
                    <!-- Card body -->
                    <div class="card-body">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                  <!-- Card -->
                  <div class="card  mb-4 card-hover">
                    <a href="course-single.html" class="card-img-top"><img src="../assets/images/course-python.jpg" alt=""
                        class="card-img-top rounded-top"></a>
                    <!-- Card body -->
                    <div class="card-body">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                  <!-- Card -->
                  <div class="card mb-4 card-hover">
                    <a href="course-single.html" class="card-img-top"><img src="../assets/images/course-gatsby.jpg" alt=""
                        class="card-img-top rounded-top"></a>
                    <!-- Card body -->
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                      <div class="row align-items-center no-gutters">
                        <div class="col-auto">
                          <img src="../assets/images/avatar-5.jpg" class="rounded-circle avatar-xs" alt="">
                        </div>
                        <div class="col ml-2">
                          <span>Morris Mccoy</span>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                  <!-- Card -->
                  <div class="card  mb-4 card-hover">
                    <a href="course-single.html" class="card-img-top"><img src="../assets/images/course-javascript.jpg" alt=""
                        class="card-img-top rounded-top"></a>
                    <!-- Card body -->
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                      ...
                      <div class="row align-items-center no-gutters">
                        <div class="col-auto">
                          <img src="../assets/images/avatar-6.jpg" class="rounded-circle avatar-xs" alt="">
                        </div>
                        <div class="col ml-2">
                          <span>Ted Hawkins</span>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                  <!-- Card -->
                  <div class="card  mb-4 card-hover">
                    <a href="course-single.html" class="card-img-top"><img src="../assets/images/course-css.jpg" alt=""
                        class="card-img-top rounded-top"></a>
                    <!-- Card body -->
                    <div class="card-body">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                  <!-- Card -->
                  <div class="card  mb-4 card-hover">
                    <a href="course-single.html" class="card-img-top"><img src="../assets/images/course-wordpress.jpg" alt=""
                        class="card-img-top rounded-top"></a>
                    <!-- Card body -->
                    <div class="card-body">
                      <h4 class="mb-2 text-truncate-line-2 "><a href="course-single.html"
                    ...
                    <div class="card-footer">
                      ...
                      <div class="row align-items-center no-gutters">
                        <div class="col-auto">
                          <img src="../assets/images/avatar-8.jpg" class="rounded-circle avatar-xs" alt="">
                        </div>
                        <div class="col ml-2">
                          <span>Claire Robertson</span>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                  <!-- Card -->
                  <div class="card  mb-4 card-hover">
                    <a href="course-single.html" class="card-img-top"><img src="../assets/images/course-node.jpg" alt=""
                        class="card-img-top rounded-top"></a>
                    <!-- Card Body -->
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                      <div class="row align-items-center no-gutters">
                        <div class="col-auto">
                          <img src="../assets/images/avatar-9.jpg" class="rounded-circle avatar-xs" alt="">
                        </div>
                        <div class="col ml-2">
                          <span>Morris Mccoy</span>
                        </div>
            ...
            <div class="tab-pane fade pb-4" id="tabPaneList" role="tabpanel" aria-labelledby="tabPaneList">
              ...
              <div class="card mb-4 card-hover">
                <div class="row no-gutters">
                  <a class="col-12 col-md-12 col-xl-3 col-lg-3 bg-cover img-left-rounded"
                    style="background-image: url(../assets/images/course-vue.jpg);" href="#!">
                    <img src="../assets/images/course-vue.jpg" alt="..." class="img-fluid d-lg-none invisible">
                  </a>
              ...
              <div class="card mb-4 card-hover">
                ...
                <div class="row no-gutters">
                  <a class="col-12 col-md-12 col-xl-3 col-lg-3 bg-cover img-left-rounded"
                    style="background-image: url(../assets/images/course-bootstrap.jpg);" href="#!">
                    <img src="../assets/images/course-bootstrap.jpg" alt="..." class="img-fluid d-lg-none invisible">
                  </a>
                  <div class="col-lg-9 col-md-12 col-12">
                    <!-- Card body -->
                    <div class="card-body">
                      ...
                      <ul class="mb-5 list-inline">
                        ...
                        <li class="list-inline-item"> <span>
                          ...
                          <span class="text-warning">4.5</span>
                          <span class="font-size-xs text-muted">(7,900)</span></li>
                      </ul>
                       <!-- Row -->
                      <div class="row align-items-center no-gutters">
                        <div class="col-auto">
              ...
              <div class="card mb-4 card-hover">
                ...
                <div class="row no-gutters">
                  <a class="col-12 col-md-12 col-xl-3 col-lg-3 bg-cover img-left-rounded"
                    style="background-image: url(../assets/images/course-graphql.jpg);" href="#!">
                    <img src="../assets/images/course-graphql.jpg" alt="..." class="img-fluid d-lg-none invisible">
                  </a>
                  <div class="col-lg-9 col-md-12 col-12">
                    <!-- Card body -->
                    <div class="card-body">
                      ...
                      <ul class="mb-5 list-inline">
                        ...
                        <li class="list-inline-item"> <span>
                          ...
                          <span class="text-warning">4.5</span>
                          <span class="font-size-xs text-muted">(8,245)</span></li>
                      </ul>
                       <!-- Row -->
                      <div class="row align-items-center no-gutters">
                        <div class="col-auto">
              ...
              <div class="card mb-4 card-hover">
                ...
                <div class="row no-gutters">
                  <a class="col-12 col-md-12 col-xl-3 col-lg-3 bg-cover img-left-rounded"
                    style="background-image: url(../assets/images/course-react.jpg);" href="#!">
                    <img src="../assets/images/course-react.jpg" alt="..." class="img-fluid d-lg-none invisible">
                  </a>
                  <div class="col-lg-9 col-md-12 col-12">
                    <!-- Card body -->
                    <div class="card-body">
                      ...
                      <ul class="mb-5 list-inline">
                        ...
                        <li class="list-inline-item"> <span>
                          ...
                          <span class="text-warning">4.5</span>
                          <span class="font-size-xs text-muted">(3,200)</span></li>
                      </ul>
                       <!-- Row -->
                      <div class="row align-items-center no-gutters">
                        <div class="col-auto">
              ...
              <div class="card mb-4 card-hover">
                <div class="row no-gutters">
                  <a class="col-12 col-md-12 col-xl-3 col-lg-3 bg-cover img-left-rounded"
                    style="background-image: url(../assets/images/course-javascript.jpg);" href="#!">
                    <img src="../assets/images/course-javascript.jpg" alt="..." class="img-fluid d-lg-none invisible">
                  </a>
                  <div class="col-lg-9 col-md-12 col-12">
                    <!-- Card body -->
                    <div class="card-body">
                      ...
                      <ul class="mb-5 list-inline">
                        ...
                        <li class="list-inline-item"> <span>
                          ...
                          <span class="text-warning">4.5</span>
                          <span class="font-size-xs text-muted">(6,600)</span></li>
                      </ul>
                       <!-- Row -->
                      <div class="row align-items-center no-gutters">
                        <div class="col-auto">
                          <img src="../assets/images/avatar-10.jpg" class="rounded-circle avatar-xs" alt="">
                        </div>
                        <div class="col ml-2">
                          <span>Ted Hawkins</span>
                        </div>
              ...
              <div class="card mb-4 card-hover">
                <div class="row no-gutters">
                  <a class="col-12 col-md-12 col-xl-3 col-lg-3 bg-cover img-left-rounded"
                    style="background-image: url(../assets/images/course-node.jpg);" href="#!">
                    <img src="../assets/images/course-node.jpg" alt="..." class="img-fluid d-lg-none invisible">
                  </a>
                  <div class="col-lg-9 col-md-12 col-12">
                    <!-- Card body -->
                    <div class="card-body">
                      ...
                      <ul class="mb-5 list-inline">
                        ...
                        <li class="list-inline-item"> <span>
                          ...
                          <span class="text-warning">4.5</span>
                          <span class="font-size-xs text-muted">(2,700)</span></li>
                      </ul>
                       <!-- row -->
                      <div class="row align-items-center no-gutters">
                        <div class="col-auto">
