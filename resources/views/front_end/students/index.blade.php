  ...
  <div class="bg-primary">
    ...
    <div class="container">
      ...
      <div class="row align-items-center no-gutters">
        <div class="col-xl-5 col-lg-6 col-md-12 my-5">
          <div class="py-5 py-lg-0">
            <h1 class="text-white display-4 font-weight-bold">Welcome to 
				<br/> Learning Norms
            </h1>
            <p class="text-white-50 mb-4 lead">
              Hand-picked and expertly crafted courses, designed for the modern students and entrepreneur.
            </p>
            <a href="pages/course-filter-list.html" class="btn btn-white">Browse Courses</a>
            <a href="#" class="btn btn-white">Are You Instructor?</a>
          </div>
        </div>
        <div class=" col-xl-7 col-lg-6 col-md-12 text-lg-right text-center">
          <img src="{{asset ('assets/images/hero-img.png') }}" alt="" class="img-fluid mb-5" />
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row align-items-center no-gutters">
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 mb-lg-0 mb-4">
          <div class="d-flex align-items-center">
            <span
              class="icon-sahpe icon-lg rounded-circle text-center border font-size-md "> <i
                class="fe fe-video"> </i></span>
            <div class="ml-3">
              <h4 class="mb-0 font-weight-semi-bold">Many online courses</h4>
    ...
    <div class="container">
      ...
      <div class="row">
          ...
          <div class="card  mb-4 card-hover">
            ...
            <div class="card-footer">
              <div class="row align-items-center no-gutters">
                ...
                <div class="col-auto">
                  <a href="#!" class="text-muted" data-toggle="tooltip" data-placement="top" title="Add to Bookmarks">
        ...
        <div class="col-lg-3 col-md-6 col-12">
          <!-- Card -->
          <div class="card  mb-4 card-hover">
            <a href="pages/course-single.html" class="card-img-top"><img src="assets/images/course-angular.jpg" alt=""
        ...
        <div class="col-lg-3 col-md-6 col-12">
          <!-- Card -->
          <div class="card  mb-4 card-hover">
            <a href="pages/course-single.html" class="card-img-top"><img src="assets/images/course-python.jpg" alt=""
                class="card-img-top rounded-top"></a>
            <!-- Card Body -->
            <div class="card-body">
              <h4 class="mb-2 text-truncate-line-2 "><a href="pages/course-single.html" class="text-inherit">The Python
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-3 col-md-6 col-12">
          <!-- Card -->
          <div class="card  mb-4 card-hover">
            <a href="pages/course-single.html" class="card-img-top"><img src="assets/images/course-gatsby.jpg" alt=""
                class="card-img-top rounded-top"></a>
            <!-- Card Body -->
            <div class="card-body">
              <h4 class="mb-2 text-truncate-line-2 "><a href="pages/course-single.html" class="text-inherit">Gatsby JS:
        ...
        <div class="col-lg-3 col-md-6 col-12">
          <!-- Card -->
          <div class="card  mb-4 card-hover">
            <a href="pages/course-single.html" class="card-img-top"><img src="assets/images/course-javascript.jpg"
        ...
        <div class="col-lg-3 col-md-6 col-12">
          <!-- Card -->
          <div class="card  mb-4 card-hover">
            <a href="pages/course-single.html" class="card-img-top"><img src="assets/images/course-css.jpg" alt=""
                class="card-img-top rounded-top"></a>
            <!-- Card Body -->
            <div class="card-body">
        ...
        <div class="col-lg-3 col-md-6 col-12">
          <!-- Card -->
          <div class="card  mb-4 card-hover">
            <a href="pages/course-single.html" class="card-img-top"><img src="assets/images/course-wordpress.jpg" alt=""
                class="card-img-top rounded-top"></a>
            <!-- Card Body -->
            <div class="card-body">
