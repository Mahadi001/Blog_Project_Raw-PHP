        ...
        <div class="col-xl-7 col-lg-7 col-md-12">
          <div>
            ...
            <p class="text-white mb-6 lead">
              JavaScript is the popular programming language which powers web pages and web applications. This course
              will get you started coding in JavaScript.
            </p>
            <div class="d-flex align-items-center">
              <a href="#!" class="text-white text-decoration-none" data-toggle="tooltip" data-placement="top" title="Add to
                           Bookmarks">
            ...
            <div class="card-header border-bottom-0 p-0">
              <div>
                ...
                <ul class="nav nav-lb-tab" id="tab" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" id="table-tab" data-toggle="pill" href="#table" role="tab"
                      aria-controls="table" aria-selected="true">Contents</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="description-tab" data-toggle="pill" href="#description" role="tab"
            ...
            <div class="card-body">
              <div class="tab-content" id="tabContent">
                      ...
                      <ul class="list-group list-group-flush">
                        <li class="list-group-item px-0 pt-0">
                          ...
                          <a class=" h4 mb-0 d-flex align-items-center text-inherit text-decoration-none active"
                            data-toggle="collapse" href="#courseTwo" aria-expanded="true" aria-controls="courseTwo">
                            <div class="mr-auto">
                        ...
                        <li class="list-group-item px-0">
                          <!-- Toggle -->
                          <a class="h4 mb-0 d-flex align-items-center text-inherit text-decoration-none"
                            data-toggle="collapse" href="#courseFour" aria-expanded="false" aria-controls="courseFour">
                            <div class="mr-auto">
                              <!-- Title -->
                        ...
                        <li class="list-group-item px-0">
                          <!-- Toggle -->
                          <a class="h4 mb-0 d-flex align-items-center text-inherit text-decoration-none"
                            data-toggle="collapse" href="#courseFive" aria-expanded="false" aria-controls="courseFive">
                            <div class="mr-auto">
                              <!-- Title -->
                              Types and Operators
                            </div>
                        ...
                        <li class="list-group-item px-0">
                          <!-- Toggle -->
                          <a class="h4 mb-0 d-flex align-items-center text-inherit text-decoration-none"
                            data-toggle="collapse" href="#courseSix" aria-expanded="false" aria-controls="courseSix">
                            <div class="mr-auto">
                              <!-- Title -->
                              Program Flow
                            </div>
                        ...
                        <li class="list-group-item px-0">
                          <!-- Toggle -->
                          <a class="h4 mb-0 d-flex align-items-center text-inherit text-decoration-none"
                            data-toggle="collapse" href="#courseNine" aria-expanded="false" aria-controls="courseNine">
                            <div class="mr-auto">
                              <!-- Title -->
                              Arrays
                            </div>
                        ...
                        <li class="list-group-item px-0">
                          <!-- Toggle -->
                          <a class="h4 mb-0 d-flex align-items-center text-inherit text-decoration-none"
                            data-toggle="collapse" href="#courseTen" aria-expanded="false" aria-controls="courseTen">
                            <div class="mr-auto">
                              <!-- Title -->
                              Scope and Hoisting
                            </div>
                        ...
                        <li class="list-group-item px-0 pb-0">
                          ...
                          <div class="collapse" id="courseEleven" data-parent="#courseAccordion">
                            <div class="pt-3 pb-2">
                              <p>
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae esse velit eos sunt
                                ab inventore est tenetur blanditiis? Voluptas eius molestiae ad itaque tempora
                                nobis minima eveniet aperiam molestias, maiores natus expedita dolores ea non possimus
                                magnam corrupt i quas rem unde quo enim porro culpa! Quaerat veritatis veniam
                                corrupti iusto.
                              </p>
                            </div>
                          </div>
                ...
                <div class="tab-pane fade" id="description" role="tabpanel" aria-labelledby="description-tab">
                  ...
                  <p>Duis facilisis ex a urna blandit ultricies. Nullam sagittis ligula non eros semper, nec mattis odio
                ...
                <div class="tab-pane fade" id="review" role="tabpanel" aria-labelledby="review-tab">
                  ...
                  <div class="mb-3">
                    ...
                    <div class="media border-bottom pb-4 mb-4">
                      <img src="../assets/images/avatar-2.jpg" alt="" class="rounded-circle avatar-lg" />
                    ...
                    <!-- Rating -->
                    <div class="media border-bottom pb-4 mb-4">
                      <img src="../assets/images/avatar-3.jpg" alt="" class="rounded-circle avatar-lg" />
                      <div class="media-body ml-3">
                    ...
                    <!-- Rating -->
                    <div class="media border-bottom pb-4 mb-4">
                      <img src="../assets/images/avatar-4.jpg" alt="" class="rounded-circle avatar-lg" />
                      <div class="media-body ml-3">
                    ...
                    <!-- Rating -->
                    <div class="media">
                      <img src="../assets/images/avatar-5.jpg" alt="" class="rounded-circle avatar-lg" />
                      <div class="media-body ml-3">
                        <h4 class="mb-1">
                          Bessie Pena
          ...
          <div class="card mb-3 mb-4">
            <div class="p-1">
              <div
                ...
                style="background-image: url(../assets/images/course-javascript.jpg);">
          ...
          <div class="card mb-4">
            <div>
              ...
              <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item bg-transparent"><i class="fe fe-calendar align-middle mr-2 text-info"></i>12
                  Article</li>
                <li class="list-group-item bg-transparent"><i
