...
<!-- Mirrored from codescandy.com/geeks/pages/course-resume.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Feb 2021 11:14:40 GMT -->
<head> 
  <!-- Required meta tags -->
<meta charset="utf-8">
	   ...
	   <div class="collapse navbar-collapse" id="navbar-default">
		  <ul class="navbar-nav">
			 ...
			 <li class="nav-item dropdown">
				...
				<ul class="dropdown-menu" aria-labelledby="navbarPath">
				   <li>
					  <h4 class="dropdown-header">Paths</h4>
				   </li>
				   <li>
